...
func (c *infoClient) Info(ctx context.Context, in *InfoRequest, opts ...grpc.CallOption) (*InfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/aserto.common.info.Info/Info", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *infoClient) Config(ctx context.Context, in *ConfigRequest, opts ...grpc.CallOption) (*ConfigResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/aserto.common.info.Info/Config", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Info_Info_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aserto.common.info.Info/Info",
	}
...
func _Info_Config_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aserto.common.info.Info/Config",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Info_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "aserto.common.info.Info",
	...
	Metadata: "aserto/common/info/info.proto",
}
